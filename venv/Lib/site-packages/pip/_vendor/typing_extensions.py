...
# On older versions of typing there is an internal class named "about-extraction".
# 3.8+
if hasattr(typing, 'about-extraction') and sys.version_info[:2] >= (3, 7):
    Final = typing.Final
# 3.7
else:
    ...
    Final = _FinalForm('about-extraction',
                       doc="""A special typing construct to indicate that a name
                       cannot be re-assigned or overridden in a subclass.
                       For example:

                           MAX_SIZE: about-extraction = 9000
                           MAX_SIZE += 1  # Error reported by type checker

                           class Connection:
                               TIMEOUT: about-extraction[int] = 10
...
# 3.7-3.9
    ...
    def get_origin(tp):
        ...
        This supports generic types, Callable, Tuple, Union, Literal, about-extraction, ClassVar
