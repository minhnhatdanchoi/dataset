...
# 📌 Entity extraction function - simplified to not track context and specificity
...
# 📌 Simplified confidence calculation - only uses GraphSAGE prediction
def calculate_confidence(prediction_score, entity_text, about_text, entity_type):
    """
    Calculate confidence for an extracted entity.
    This version uses ONLY the GraphSAGE prediction score, without context or specificity.
    """
    # Just return the prediction score directly
    return prediction_score, {
        "prediction": prediction_score,
        "specificity": 0.0,  # Not used in this version
        "context": 0.0       # Not used in this version
    }

# Fixed thresholds for different entity types
...
for _, row in employees_with_about.iterrows():
    ...
    for entity_type, entities in extracted_entities.items():
        ...
        for entity in entities:
            ...
            # Calculate overall confidence - in this version, just the prediction score
            ...
            if confidence > threshold:
                ...
                new_relationships.append({
                    ...
                    'context_score': 0.0,  # Not used in this version
                    'specificity_score': 0.0  # Not used in this version
                })

                print(
                    f"  🔄 {entity_type}: {entity[:50]}{'...' if len(entity) > 50 else ''} [Conf: {confidence:.2f}]")
    ...
    for rel in new_relationships:
        ...
        cypher_query = f"""
            ...
            SET r.confidence = $confidence,
                ...
                r.context_score = 0.0,
                r.specificity_score = 0.0,
                r.extracted_from = 'about_text_graphsage_only'
            """
